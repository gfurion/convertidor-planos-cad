...
### Progreso granular
- Barra de progreso por archivo (no solo "procesando...")
- Indicador: "Archivo 3 de 15: proyecto_planta.dwg"
- Tiempo estimado restante

### Drag & drop
- Arrastrar archivos .dwg/.dxf directamente a la ventana
- Arrastrar carpetas completas
- Feedback visual (highlight) al pasar sobre la zona de drop
...
### Apariencia
- Alternar modo oscuro (superhero) y modo claro (flatly)
...
- Texto informativo al lado del botón: *"Puedes seleccionar uno o varios archivos DXF/DWG"*
- Badge dinámico después de seleccionar: *"12 archivos seleccionados"*
- Tooltip en el botón de selección
- Placeholder vacío: *"Arrastra aquí tus planos o haz clic en 'Buscar y Convertir Planos'"*
- Título personalizado en la ventana `filedialog`: *"Selecciona uno o varios archivos DXF/DWG"*
